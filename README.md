# Hugo TiU - Open Education Template

[![Hugo](https://img.shields.io/badge/hugo-0.68-blue.svg)](https://gohugo.io)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)

### This is a [Hugo](https://gohugo.io) open education theme based on the original [Hugo Book theme](https://github.com/alex-shpak/hugo-book)

![Screenshot](https://github.com/tilburgsciencehub/hugo-tiu/blob/master/images/screenshot.png)
...
- Clean design with the Tilburg University brand and identity
...
Then run hugo (or set `theme = "hugo-tiu"`/`theme: hugo-tiu` in configuration file)
...
- [Example menu](https://github.com/tilburgsciencehub/hugo-tiu/blob/master/exampleSite/content/menu/index.md)
- [Example config file](https://github.com/tilburgsciencehub/hugo-tiu/blob/master/exampleSite/config.yaml)
...
You can also see the `yaml` example [here](https://github.com/tilburgsciencehub/hugo-tiu/blob/master/exampleSite/config.yaml).
...
[params]
  ...
  BookRepo = 'https://github.com/tilburgsciencehub/hugo-tiu'
...
## Shortcodes from the original Hugo Book theme
